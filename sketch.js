...
//varaiables para cargar los sonidos
...
function preload() {
  ...
  // cargar los sonidos en las variables correspondientes
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    //reproducir el sonido de puntuación cuando sea mayor a cero y mútiplo del 1000
    ...
    if (keyDown("space") && trex.y >= 160) {
      trex.velocityY = -12;
      //reproducir el sonido del salto
     jumpSound.play()
    }
    ...
    if (obstaclesGroup.isTouching(trex)) {
      gameState = END;
      //reproducir el sonido de choque contra un obstáculo
     dieSound.play()
    }
  }
